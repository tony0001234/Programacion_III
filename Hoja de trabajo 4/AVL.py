...
while opcion != 5:
    ...
    if opcion == 1:
        ...
        break
'''
arbol.insert(1, 'chess', 30)
arbol.insert(2, 'jack', 10)
arbol.insert(3, 'charly', 45)
arbol.insert(4, 'kofy', 64)

#arbol.agregarArch()
arbol.mostrar(arbol.raiz)
arbol.generar_arbol_grafico()
#arbol.buscar(input("Igrese el valor que desea buscar: "))
arbol.buscarPorDPI(input("ingrese el DPI a buscar: "))
'''